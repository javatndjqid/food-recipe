...
export default {
  ...
  lectureList: (category) => axios.get(`${process.env.VUE_APP_API_SEARCH}/recipe/detail/lectures/${category}`),
  productList: (stuff) => axios.get(`${process.env.VUE_APP_API_SEARCH}/recipe/detail/market`, stuff),
